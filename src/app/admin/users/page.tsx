              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Gerencie o acesso e permissões da plataforma.
                  </p>
                </div>
              </div>
              <button
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFormData({ ...formData, adAccountName: e.target.value })
                            }
            ...
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-200">
              <div className="bg-card border border-border rounded-2xl p-8 w-full max-w-md shadow-2xl glass neon-border animate-in zoom-in-95 duration-200">
                ...
                <p className="text-foreground mb-8">
                  ...
                  <span className="font-bold">{userToDelete?.name}</span>? Todos os dados associados
                  serão perdidos.
                </p>
