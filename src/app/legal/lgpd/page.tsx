    ...
    <div className="min-h-screen bg-background text-foreground p-8 font-sans">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <section className="space-y-4">
          ...
          <p>
            De acordo com a LGPD, você tem o direito de acessar, corrigir, portar e excluir seus
            dados pessoais, bem como de revogar seu consentimento a qualquer momento.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            O TrackFlow atua como controlador de seus dados pessoais. Para exercer seus direitos ou
            tirar dúvidas, entre em contato com nosso Encarregado de Proteção de Dados.
          </p>
        </section>
