      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            contato, bem como informações sobre o uso da plataforma.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            Usamos as informações coletadas para operar, manter e melhorar a plataforma, bem como
            para nos comunicarmos com você sobre atualizações e ofertas.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            informações com prestadores de serviços que nos ajudam a operar a plataforma.
          </p>
        </section>
      </div>
    </div>
