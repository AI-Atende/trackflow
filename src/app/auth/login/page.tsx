            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer group">
                <div className="relative">
                  ...
                  />
                  <div
                    className={`w-5 h-5 border rounded transition-colors flex items-center justify-center ${rememberMe ? 'bg-brand-500 border-brand-500' : 'border-muted-foreground bg-transparent'}`}
                  >
